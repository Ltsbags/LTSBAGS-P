        ...
        <div className="space-y-3">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-3">
            {[
              ...
              { name: 'Customer CRM', href: '/admin/customers', icon: Users, desc: 'Clients & Procurement', color: 'text-purple-400 bg-purple-500/10 border-purple-500/20' },
              { name: 'PDF Catalogues', href: '/admin/catalogues', icon: FileText, desc: 'Brochures & Lookbooks', color: 'text-cyan-400 bg-cyan-500/10 border-cyan-500/20' },
              ...
              { name: 'Payments & UTR', href: '/admin/payments', icon: CreditCard, desc: 'Payment Log & Gateway', color: 'text-lime-400 bg-lime-500/10 border-lime-500/20' },
              { name: '301 Redirects', href: '/admin/redirects', icon: Compass, desc: 'SEO URL Migrations', color: 'text-sky-400 bg-sky-500/10 border-sky-500/20' },
